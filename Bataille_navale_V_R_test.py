...
def presentation():
    ...
    img_fond = PhotoImage(file="A:\Cours\Projet Python\Projet Python L_R\images\presentation_bt.gif")
...
img_eau = PhotoImage(file="A:\Cours\Projet Python\Projet Python L_R\images\eau.png")
...
img_gagne=PhotoImage(file="A:\Cours\Projet Python\Projet Python L_R\images\_victoire.png")
img_perdu=PhotoImage(file="A:\Cours\Projet Python\Projet Python L_R\images\defaite.png")
img_vict=PhotoImage(file="A:\Cours\Projet Python\Projet Python L_R\images\_victoire_text.png")
img_def=PhotoImage(file="A:\Cours\Projet Python\Projet Python L_R\images\defeat_text.png")
